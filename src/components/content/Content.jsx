...
function Content( post ) {
  ...
  return (
    ...
    <div className="content_item w-full h-full mt-16 relative">
        <ContentMenu post={post}/>
        <Description post={post} />
        <div className='bg-green-rating w-12 h-12  rounded-xl rotate-45 absolute top-0 -left-5'>
          <svg xmlns="http://www.w3.org/2000/svg" fill='#fff' className='w-4 h-4 -rotate-45 flex items-center justify-center' viewBox="0 -56 512 512" id="subtitles">
